...
public class MinExclusiveNormalizer extends Normalizer<MinExclusiveModel>
{
	...
	protected void stage2(MinExclusiveModel model)
	{
	}

	protected void stage3(MinExclusiveModel model)
	{
	}

	protected void stage4(MinExclusiveModel model)
	{
	}

	protected void stage5(MinExclusiveModel model)
	{
	}

	protected void stage6(MinExclusiveModel model)
	{
	}
}
