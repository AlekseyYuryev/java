...
public class ModelDirectory extends HandlerDirectory<Node,Class<? extends Model>>
{
	private static final Map<String,Class<? extends Model>> classes = new HashMap<String,Class<? extends Model>>(39);
	private static final Collection<String> keys;
	private static final ModelDirectory instance = new ModelDirectory();
	...
	public static ModelDirectory instance()
	{
		return instance;
	}

	protected Class<? extends Model> lookup(Node key)
	{
		final String elementName = key.getLocalName();
		if(elementName == null)
		...
		return classes.get(elementName);
	}
}
