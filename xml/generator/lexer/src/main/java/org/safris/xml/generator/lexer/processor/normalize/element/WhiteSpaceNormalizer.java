...
public class WhiteSpaceNormalizer extends Normalizer<WhiteSpaceModel> {
    ...
    protected void stage2(WhiteSpaceModel model) {
    }

    protected void stage3(WhiteSpaceModel model) {
    }

    protected void stage4(WhiteSpaceModel model) {
    }

    protected void stage5(WhiteSpaceModel model) {
    }

    protected void stage6(WhiteSpaceModel model) {
    }
}
