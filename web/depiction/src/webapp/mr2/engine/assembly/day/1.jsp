...
<head>
  ...
  <title>Engine Assembly Day 1</title>
</head>

<%!
  File[] dirs =
  {
    new File("/cars/mr2/engine/assembly/day/1")
  };
...
<table align="center">
  <tr>
    <td align="center">
      <p></p>
      <span>Engine Assembly Day 1</span><br>
      <a class="normal" href="http://www.safris.com/car/mr2/">Toyota MR2 Pictures</a>
      <br>
      <table>
        <tr>
          <td align="left" width="600">
<p>These pictures are of what I begin my dream-engine assembly from. I began my assembly in my studio in San Francisco, neatly tucking away my engine every night  right next to my bed.<br>
<br>
This is a long-block pre-assembled by a engine shop in Massachusetts. The pistons are JE 8.5:1 compression pistons, and the cams are HKS 272 (both exhaust and intake).</p>
          </td>
        </tr>
      </table>
