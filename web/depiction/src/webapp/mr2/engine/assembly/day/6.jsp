...
<head>
	...
	<title>Engine Assembly Day 6</title>
</head>

<%!
	File[] dirs =
	{
		new File("/cars/mr2/engine/assembly/day/6")
	};
...
<table align="center">
	<tr>
		<td align="center">
			<p></p>
			<span>Engine Assembly Day 6</span><br>
			<a class="normal" href="http://www.safris.com/car/mr2/">Toyota MR2 Pictures</a>
			<br>
			<table>
				<tr>
					<td align="left" width="600">
<p>Today I placed the water pump onto the block. I was very careful and precise with my method, and even lined the gasket with a thin layer of silicone.</p>
					</td>
				</tr>
			</table>
