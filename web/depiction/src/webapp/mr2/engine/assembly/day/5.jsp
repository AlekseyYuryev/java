...
<head>
	...
	<title>Engine Assembly Day 5</title>
</head>

<%!
	File[] dirs =
	{
		new File("/cars/mr2/engine/assembly/day/5")
	};
...
<table align="center">
	<tr>
		<td align="center">
			<p></p>
			<span>Engine Assembly Day 5</span><br>
			<a class="normal" href="http://www.safris.com/car/mr2/">Toyota MR2 Pictures</a>
			<br>
			<table>
				<tr>
					<td align="left" width="600">
<p>Today I decided to do some plumbing. Specifically, I installed the HFH (Hose from Hell - called so because of the intense heat that it is exposed to). You can also see a couple of water hoses being atached. No biggie, right?! The funny thing is that eventually I would end up redoing this entire system of hoses and fittings.</p>
					</td>
				</tr>
			</table>
