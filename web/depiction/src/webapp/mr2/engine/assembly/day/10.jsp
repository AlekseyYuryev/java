...
<head>
	...
	<title>Engine Assembly Day 10</title>
</head>

<%!
	File[] dirs =
	{
		new File("/cars/mr2/engine/assembly/day/8")
	};
...
<table align="center">
	<tr>
		<td align="center">
			<p></p>
			<span>Engine Assembly Day 10</span><br>
			<a class="normal" href="http://www.safris.com/car/mr2/">Toyota MR2 Pictures</a>
			<br>
			<table>
				<tr>
					<td align="left" width="600">
<p>OMG I LOVED this part of my project. This was perhaps one of my most incredible jobs. I borred two stock fuel rails to 5/16" through their full lengths. This is only part 1 of my fuel system modifications. The fuel system is actually the piece I am most proud of.</p>
					</td>
				</tr>
			</table>
