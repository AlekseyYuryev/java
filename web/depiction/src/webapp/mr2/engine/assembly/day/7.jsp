...
<head>
	...
	<title>Engine Assembly Day 7</title>
</head>

<%!
	File[] dirs =
	{
		new File("/cars/mr2/engine/assembly/day/7")
	};
...
<table align="center">
	<tr>
		<td align="center">
			<p></p>
			<span>Engine Assembly Day 7</span><br>
			<a class="normal" href="http://www.safris.com/car/mr2/">Toyota MR2 Pictures</a>
			<br>
			<table>
				<tr>
					<td align="left" width="600">
<p>Ah yes, a couple of things happened here. Namely, I thought I would place the TEC3 water temp sensor into the stock location of the stock temp sensor. This required re-threading the threads to fit and NPT thread (I hate NPT). At this point, I still didnt know that the stock MR2 water temp sensor will work with the TEC3.<br>
<br>
Also, you see my exhaust headers on the floor. Sticking out from the junction of the individual headers is an EGT sensor. I really should have put this sensor into the hottest cylinder's path, but I didn't know enough about all of this as of yet.</p>
					</td>
				</tr>
			</table>
