...
<head>
  ...
  <title>Engine Assembly Day 2</title>
</head>

<%!
  File[] dirs =
  {
    new File("/cars/mr2/engine/assembly/day/2")
  };
...
<table align="center">
  <tr>
    <td align="center">
      <p></p>
      <span>Engine Assembly Day 2</span><br>
      <a class="normal" href="http://www.safris.com/car/mr2/">Toyota MR2 Pictures</a>
      <br>
      <table>
        <tr>
          <td align="left" width="600">
<p>At this point in the project I figured I would take pictures of every step taken in building my engine. Little did I know that this project was going to get complicated soon. So complicated, in fact, that the frequency of my pictures greatly deminished soon after this point here.</p>
          </td>
        </tr>
      </table>
