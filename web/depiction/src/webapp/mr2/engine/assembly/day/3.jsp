...
<head>
  ...
  <title>Engine Assembly Day 3</title>
</head>

<%!
  File[] dirs =
  {
    new File("/cars/mr2/engine/assembly/day/3")
  };
...
<table align="center">
  <tr>
    <td align="center">
      <p></p>
      <span>Engine Assembly Day 3</span><br>
      <a class="normal" href="http://www.safris.com/car/mr2/">Toyota MR2 Pictures</a>
      <br>
      <table>
        <tr>
          <td align="left" width="600">
<p>This day was spent cleaning parts, really. I concentrated on preparing sections of the engine one step at a time. In these pictures you see the installation of the oil squirters in the block right over the crank.</p>
          </td>
        </tr>
      </table>
