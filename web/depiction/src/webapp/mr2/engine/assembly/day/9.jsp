...
<head>
	...
	<title>Engine Assembly Day 9</title>
</head>

<%!
	File[] dirs =
	{
		new File("/cars/mr2/intercooler/radiator/day/2")
	};
...
<table align="center">
	<tr>
		<td align="center">
			<p></p>
			<span>Engine Assembly Day 9</span><br>
			<a class="normal" href="http://www.safris.com/car/mr2/">Toyota MR2 Pictures</a>
			<br>
			<table>
				<tr>
					<td align="left" width="600">
<p>Here you see the joys of fitting the intercooler radiator into the car. Believe it or not, but it actually takes on the order of 2 hours just to fit the radiator in assuming the condenser and stock radiator are already gone.</p>
					</td>
				</tr>
			</table>
