...
<head>
	...
	<title>Engine Assembly Day 4</title>
</head>

<%!
	File[] dirs =
	{
		new File("/cars/mr2/engine/assembly/day/4")
	};
...
<table align="center">
	<tr>
		<td align="center">
			<p></p>
			<span>Engine Assembly Day 4</span><br>
			<a class="normal" href="http://www.safris.com/car/mr2/">Toyota MR2 Pictures</a>
			<br>
			<table>
				<tr>
					<td align="left" width="600">
<p>This was a day when I decided to mount the TEC3 water temp sensor. The mounting of the sensor came out ok. You see it here being placed in the junction where the water will bypass through the thermostat and go toward the radtiator. The reason that I didn't really like this setup, though, is simply because it is a hack. Later I found out that the stock water temp sensor used on the MR2 is electrically identical to the one the TEC3 expects.<br>
<br>
Also, though subtle, you can see that I put an oil pressure sensor on the oil filter mount. Speaking of which: I will not be putting the oil filter in the stock location. Using an oil relocation kit allows me to place the filter in a more accessible location, and possibly attach an oil cooler into the series as well (this actually got done too).</p>
					</td>
				</tr>
			</table>
