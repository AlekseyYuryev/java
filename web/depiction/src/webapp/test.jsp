...
<head>
  ...
  <title>Marine Graduation Part 1</title>
</head>
...
<table align="center">
  <tr>
    <td align="center">
      ...
      <span>Marine Graduation</span><br>
      <a class="normal" href="http://www.safris.com/cody.html">Cody's Pictures</a>
      <table cellspacing="10" cellpadding="0" align="center" bordercolor="666666">
        <tr><td colspan="4"><hr></td>
  <ui:dataGrid items="${'${imageFiles}'}" var="imageFile" name="datagrid1" cellPadding="0" cellSpacing="0">
    <columns>
      <column width="100" order="true">
        <item value="${imageFile.link}" hAlign="left"/>
...
//						name = name.substring(0, name.lastIndexOf("."));
            new ImageFile(files[i], thumbnailSize);
            buffer.append("<td><center><a href='image.jsp?i=" + URLEncoder.encode(ImageFile.getLocalFile(files[i]).getPath()) + "'>");
            buffer.append("<img class='image-cell' src='" + ImageServlet.getPictureURL() + URLEncoder.encode(ImageFile.getLocalFile(ImageFile.getThumbnailFile(files[i])).getPath()) + "' border='1'></a></center></td>");
