...
<head>
	...
	<title>Night at 1015</title>
</head>

<%!
	File[] dirs =
	{
		new File("/party/10-21.5-2005")
	};
...
<table align="center">
	<tr>
		<td align="center">
			<p><br></p>
			<span><font color="333333">Night at 1015</font></span><br>
...
//						buffer.append("<br>" + imageFile.getWidth() + "x" + imageFile.getHeight() + "<br>" + name + "</a></td>");
					...
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/10-21.5-2005/MOV00001.avi\")'>MOV00001</a><br>");
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/10-21.5-2005/MOV00002.avi\")'>MOV00002</a><br>");
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/10-21.5-2005/MOV00003.avi\")'>MOV00003</a><br>");
