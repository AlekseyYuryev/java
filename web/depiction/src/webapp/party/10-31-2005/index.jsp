...
<head>
	...
	<title>Castro Halloween</title>
</head>

<%!
	File[] dirs =
	{
		new File("/party/10-31-2005")
	};
...
<table align="center">
	<tr>
		<td align="center">
			<p><br></p>
			<span><font color="333333">Castro Halloween</font></span><br>
...
//						buffer.append("<br>" + imageFile.getWidth() + "x" + imageFile.getHeight() + "<br>" + name + "</a></td>");
					...
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/10-31-2005/MOV00001.avi\")'>MOV00001</a><br>");
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/10-31-2005/MOV00002.avi\")'>MOV00002</a><br>");
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/10-31-2005/MOV00003.avi\")'>MOV00003</a><br>");
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/10-31-2005/MOV00004.avi\")'>MOV00004</a><br>");
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/10-31-2005/MOV00005.avi\")'>MOV00005</a><br>");
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/10-31-2005/MOV00006.avi\")'>MOV00006</a>");
