...
<head>
	...
	<title>Loveparade - San Francisco</title>
</head>

<%!
	File[] dirs =
	{
		new File("/party/9-24-2005")
	};
...
<table align="center">
	<tr>
		<td align="center">
			<p><br></p>
			<span><font color="333333">Loveparade - San Francisco</font></span><br>
...
//						buffer.append("<br>" + imageFile.getWidth() + "x" + imageFile.getHeight() + "<br>" + name + "</a></td>");
					...
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/9-24-2005/MOV00001.avi\")'>MOV00001</a><br>");
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/9-24-2005/MOV00002.avi\")'>MOV00002</a><br>");
					buffer.append("<a href='javascript:play(\"http://www.safris.com/pictures/party/9-24-2005/MOV00003.avi\")'>MOV00003</a>");
