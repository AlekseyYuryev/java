...
<%!
	File[] dirs =
	{
		new File("/cody/Marine Graduation 1"),
		new File("/cody/Marine Graduation 2"),
		new File("/cody/Marine Graduation 3")
	};
...
<table align="center">
	<tr>
		<td align="center">
			...
			<a class="normal" href="http://www.safris.com/cody/">Cody's Pictures</a>
