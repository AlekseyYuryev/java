...
/**
 * Each label must not contain more than ONE field Label elements shouldn't be
 * nested.
 *
 * @author Source generated with: <u>xml Bind for Java</u> by <b>Seva Safris &lt;seva@safris.org&gt;</b>
 */

public class Label extends org.safris.web.depiction.schema.xhtml.strict.IInline<org.safris.xml.bind.runtime.lang.ComplexType>
{
  private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "label");

  static
  {
    getElementBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.Label.class.getName());
  }

  private java.lang.String text = null;
  private org.safris.web.depiction.schema.xhtml.strict.Label.ForAttr _forAttr = null;
  private org.safris.web.depiction.schema.xhtml.strict.Label.AccesskeyAttr _accesskeyAttr = null;
  private org.safris.web.depiction.schema.xhtml.strict.Label.OnfocusAttr _onfocusAttr = null;
  private org.safris.web.depiction.schema.xhtml.strict.Label.OnblurAttr _onblurAttr = null;
  ...
  public Label(org.safris.web.depiction.schema.xhtml.strict.IInline<org.safris.xml.bind.runtime.lang.ComplexType> binding)
  {
    super(binding);
    if(binding instanceof org.safris.web.depiction.schema.xhtml.strict.Label)
    {
      org.safris.web.depiction.schema.xhtml.strict.Label element = (org.safris.web.depiction.schema.xhtml.strict.Label)binding;
      this.text = element.text;
      this._forAttr = element._forAttr != null ? element._forAttr.clone() : null;
  ...
  public void setForAttr(org.safris.web.depiction.schema.xhtml.strict.Label.ForAttr _forAttr)
  {
    this._forAttr = _forAttr;
  }

  public org.safris.web.depiction.schema.xhtml.strict.Label.ForAttr getForAttr()
  {
    return _forAttr;
  }

  public void setAccesskeyAttr(org.safris.web.depiction.schema.xhtml.strict.Label.AccesskeyAttr _accesskeyAttr)
  {
    this._accesskeyAttr = _accesskeyAttr;
  }

  public org.safris.web.depiction.schema.xhtml.strict.Label.AccesskeyAttr getAccesskeyAttr()
  {
    return _accesskeyAttr;
  }

  public void setOnfocusAttr(org.safris.web.depiction.schema.xhtml.strict.Label.OnfocusAttr _onfocusAttr)
  {
    this._onfocusAttr = _onfocusAttr;
  }

  public org.safris.web.depiction.schema.xhtml.strict.Label.OnfocusAttr getOnfocusAttr()
  {
    return _onfocusAttr;
  }

  public void setOnblurAttr(org.safris.web.depiction.schema.xhtml.strict.Label.OnblurAttr _onblurAttr)
  {
    this._onblurAttr = _onblurAttr;
  }

  public org.safris.web.depiction.schema.xhtml.strict.Label.OnblurAttr getOnblurAttr()
  {
    return _onblurAttr;
  }
  ...
  protected org.w3c.dom.Element marshal(org.w3c.dom.Element parent, javax.xml.namespace.QName name, javax.xml.namespace.QName typeName) throws org.safris.xml.bind.runtime.lang.MarshalException
  {
    ...
    if(_forAttr != null)
    {
      element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_forAttr, "for", element));
    }
  ...
  protected void parse(org.w3c.dom.Element element) throws org.safris.xml.bind.runtime.lang.UnmarshalException, org.safris.xml.bind.runtime.lang.ValidationException
  {
    ...
    for(int i = 0; i < namedNodeMap.getLength(); i++)
    {
      ...
      else if("for".equals(attribute.getLocalName()))
      {
        this._forAttr = (org.safris.web.depiction.schema.xhtml.strict.Label.ForAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Label.ForAttr.class, element, attribute);
      }
      else if("accesskey".equals(attribute.getLocalName()))
      {
        this._accesskeyAttr = (org.safris.web.depiction.schema.xhtml.strict.Label.AccesskeyAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Label.AccesskeyAttr.class, element, attribute);
      }
      else if("onfocus".equals(attribute.getLocalName()))
      {
        this._onfocusAttr = (org.safris.web.depiction.schema.xhtml.strict.Label.OnfocusAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Label.OnfocusAttr.class, element, attribute);
      }
      else if("onblur".equals(attribute.getLocalName()))
      {
        this._onblurAttr = (org.safris.web.depiction.schema.xhtml.strict.Label.OnblurAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Label.OnblurAttr.class, element, attribute);
      }
  ...
  public org.safris.web.depiction.schema.xhtml.strict.Label clone()
  {
    return new org.safris.web.depiction.schema.xhtml.strict.Label(this);
  }
  ...
  public boolean equals(java.lang.Object obj)
  {
    ...
    if(!(obj instanceof org.safris.web.depiction.schema.xhtml.strict.Label))
      return false;

    org.safris.web.depiction.schema.xhtml.strict.Label binding = (org.safris.web.depiction.schema.xhtml.strict.Label)obj;
    if((this.text == null && binding.text != null) || (this.text != null && !this.text.equals(binding.text)))
      return false;

    if((this._forAttr == null && binding._forAttr != null) || (this._forAttr != null && !this._forAttr.equals(binding._forAttr)))
      return false;
  ...
  public int hashCode()
  {
    ...
    stringBuffer.append(_forAttr != null ? _forAttr.hashCode() : 0).append("-");
  ...
  */
  ...
  public static class ForAttr extends org.safris.xml.bind.runtime.types.IdRefType<org.safris.xml.bind.runtime.lang.Attribute>
  {
    private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "for");

    public ForAttr(org.safris.xml.bind.runtime.types.IdRefType<org.safris.xml.bind.runtime.lang.Attribute> binding)
    {
      super(binding);
    }

    public ForAttr(java.lang.String value)
    {
      super(value);
    }
    ...
    public org.safris.web.depiction.schema.xhtml.strict.Label.ForAttr clone()
    {
      return new org.safris.web.depiction.schema.xhtml.strict.Label.ForAttr(this);
    }
  ...
  */
  ...
  public static class AccesskeyAttr extends org.safris.web.depiction.schema.xhtml.strict.ICharacter<org.safris.xml.bind.runtime.lang.Attribute>
  {
    ...
    public org.safris.web.depiction.schema.xhtml.strict.Label.AccesskeyAttr clone()
    {
      return new org.safris.web.depiction.schema.xhtml.strict.Label.AccesskeyAttr(this);
    }
  ...
  */
  ...
  public static class OnfocusAttr extends org.safris.web.depiction.schema.xhtml.strict.IScript<org.safris.xml.bind.runtime.lang.Attribute>
  {
    ...
    public org.safris.web.depiction.schema.xhtml.strict.Label.OnfocusAttr clone()
    {
      return new org.safris.web.depiction.schema.xhtml.strict.Label.OnfocusAttr(this);
    }
  ...
  */
  ...
  public static class OnblurAttr extends org.safris.web.depiction.schema.xhtml.strict.IScript<org.safris.xml.bind.runtime.lang.Attribute>
  {
    ...
    public org.safris.web.depiction.schema.xhtml.strict.Label.OnblurAttr clone()
    {
      return new org.safris.web.depiction.schema.xhtml.strict.Label.OnblurAttr(this);
    }
