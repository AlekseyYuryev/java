...
public class Find extends org.safris.web.depiction.schema.xhtml.tags.ITaglib<org.safris.xml.bind.runtime.lang.ComplexType>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://web.safris.org/depiction/tags.xsd", "find");

	static
	{
		getElementBindings().put(NAME, org.safris.web.depiction.schema.tags.Find.class.getName());
	}

	private org.safris.web.depiction.schema.tags.Find.PathAttr _pathAttr = null;
	private org.safris.web.depiction.schema.tags.Find.NameAttr _nameAttr = null;
	private org.safris.web.depiction.schema.tags.Find.VarAttr _varAttr = null;

	public Find(org.safris.web.depiction.schema.xhtml.tags.ITaglib<org.safris.xml.bind.runtime.lang.ComplexType> binding)
	{
		super(binding);
		if(binding instanceof org.safris.web.depiction.schema.tags.Find)
		{
			org.safris.web.depiction.schema.tags.Find element = (org.safris.web.depiction.schema.tags.Find)binding;
	...
	public void setPathAttr(org.safris.web.depiction.schema.tags.Find.PathAttr _pathAttr)
	{
		this._pathAttr = _pathAttr;
	}

	public org.safris.web.depiction.schema.tags.Find.PathAttr getPathAttr()
	{
		return _pathAttr;
	}

	public void setNameAttr(org.safris.web.depiction.schema.tags.Find.NameAttr _nameAttr)
	{
		this._nameAttr = _nameAttr;
	}

	public org.safris.web.depiction.schema.tags.Find.NameAttr getNameAttr()
	{
		return _nameAttr;
	}

	public void setVarAttr(org.safris.web.depiction.schema.tags.Find.VarAttr _varAttr)
	{
		this._varAttr = _varAttr;
	}

	public org.safris.web.depiction.schema.tags.Find.VarAttr getVarAttr()
	{
		return _varAttr;
	}
	...
	protected void parse(org.w3c.dom.Element element) throws org.safris.xml.bind.runtime.lang.UnmarshalException, org.safris.xml.bind.runtime.lang.ValidationException
	{
		...
		for(int i = 0; i < namedNodeMap.getLength(); i++)
		{
			...
			{
				this._pathAttr = (org.safris.web.depiction.schema.tags.Find.PathAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.tags.Find.PathAttr.class, element, attribute);
			}
			else if("name".equals(attribute.getLocalName()))
			{
				this._nameAttr = (org.safris.web.depiction.schema.tags.Find.NameAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.tags.Find.NameAttr.class, element, attribute);
			}
			else if("var".equals(attribute.getLocalName()))
			{
				this._varAttr = (org.safris.web.depiction.schema.tags.Find.VarAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.tags.Find.VarAttr.class, element, attribute);
			}
		}
	...
	public org.safris.web.depiction.schema.tags.Find clone()
	{
		return new org.safris.web.depiction.schema.tags.Find(this);
	}
	...
	public boolean equals(java.lang.Object obj)
	{
		...
		if(!(obj instanceof org.safris.web.depiction.schema.tags.Find))
			return false;

		org.safris.web.depiction.schema.tags.Find binding = (org.safris.web.depiction.schema.tags.Find)obj;
	...
	*/
	...
	public static class PathAttr extends org.safris.xml.bind.runtime.types.StringType<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.tags.Find.PathAttr clone()
		{
			return new org.safris.web.depiction.schema.tags.Find.PathAttr(this);
		}
	...
	*/
	...
	public static class NameAttr extends org.safris.xml.bind.runtime.types.StringType<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.tags.Find.NameAttr clone()
		{
			return new org.safris.web.depiction.schema.tags.Find.NameAttr(this);
		}
	...
	*/
	...
	public static class VarAttr extends org.safris.xml.bind.runtime.types.StringType<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.tags.Find.VarAttr clone()
		{
			return new org.safris.web.depiction.schema.tags.Find.VarAttr(this);
		}
