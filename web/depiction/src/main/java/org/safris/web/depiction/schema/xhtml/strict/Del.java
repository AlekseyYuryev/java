...
public class Del extends org.safris.web.depiction.schema.xhtml.strict.IFlow<org.safris.xml.bind.runtime.lang.ComplexType>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "del");

	static
	{
		getElementBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.Del.class.getName());
	}

	private java.lang.String text = null;
	private org.safris.web.depiction.schema.xhtml.strict.Del.CiteAttr _citeAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Del.DatetimeAttr _datetimeAttr = null;
	...
	public Del(java.lang.String text)
	{
		super(text);
	}

	public Del(org.safris.web.depiction.schema.xhtml.strict.IFlow<org.safris.xml.bind.runtime.lang.ComplexType> binding)
	{
		super(binding);
		if(binding instanceof org.safris.web.depiction.schema.xhtml.strict.Del)
		{
			org.safris.web.depiction.schema.xhtml.strict.Del element = (org.safris.web.depiction.schema.xhtml.strict.Del)binding;
			this.text = element.text;
			this._citeAttr = element._citeAttr != null ? element._citeAttr.clone() : null;
			this._datetimeAttr = element._datetimeAttr != null ? element._datetimeAttr.clone() : null;
	...
	public void setCiteAttr(org.safris.web.depiction.schema.xhtml.strict.Del.CiteAttr _citeAttr)
	{
		this._citeAttr = _citeAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Del.CiteAttr getCiteAttr()
	{
		return _citeAttr;
	}

	public void setDatetimeAttr(org.safris.web.depiction.schema.xhtml.strict.Del.DatetimeAttr _datetimeAttr)
	{
		this._datetimeAttr = _datetimeAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Del.DatetimeAttr getDatetimeAttr()
	{
		return _datetimeAttr;
	}
	...
	protected org.w3c.dom.Element marshal(org.w3c.dom.Element parent, javax.xml.namespace.QName name, javax.xml.namespace.QName typeName) throws org.safris.xml.bind.runtime.lang.MarshalException
	{
		...
		if(_citeAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_citeAttr, "cite", element));
		}

		if(_datetimeAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_datetimeAttr, "datetime", element));
		}
	...
	protected void parse(org.w3c.dom.Element element) throws org.safris.xml.bind.runtime.lang.UnmarshalException, org.safris.xml.bind.runtime.lang.ValidationException
	{
		...
		for(int i = 0; i < namedNodeMap.getLength(); i++)
		{
			...
			else if("cite".equals(attribute.getLocalName()))
			{
				this._citeAttr = (org.safris.web.depiction.schema.xhtml.strict.Del.CiteAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Del.CiteAttr.class, element, attribute);
			}
			else if("datetime".equals(attribute.getLocalName()))
			{
				this._datetimeAttr = (org.safris.web.depiction.schema.xhtml.strict.Del.DatetimeAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Del.DatetimeAttr.class, element, attribute);
			}
	...
	public org.safris.web.depiction.schema.xhtml.strict.Del clone()
	{
		return new org.safris.web.depiction.schema.xhtml.strict.Del(this);
	}
	...
	public boolean equals(java.lang.Object obj)
	{
		...
		if(!(obj instanceof org.safris.web.depiction.schema.xhtml.strict.Del))
			return false;

		org.safris.web.depiction.schema.xhtml.strict.Del binding = (org.safris.web.depiction.schema.xhtml.strict.Del)obj;
		if((this.text == null && binding.text != null) || (this.text != null && !this.text.equals(binding.text)))
			return false;

		if((this._citeAttr == null && binding._citeAttr != null) || (this._citeAttr != null && !this._citeAttr.equals(binding._citeAttr)))
			return false;

		if((this._datetimeAttr == null && binding._datetimeAttr != null) || (this._datetimeAttr != null && !this._datetimeAttr.equals(binding._datetimeAttr)))
			return false;
	...
	public int hashCode()
	{
		...
		stringBuffer.append(_citeAttr != null ? _citeAttr.hashCode() : 0).append("-");
		stringBuffer.append(_datetimeAttr != null ? _datetimeAttr.hashCode() : 0).append("-");
	...
	*/
	...
	public static class CiteAttr extends org.safris.web.depiction.schema.xhtml.strict.IURI<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "cite");

		public CiteAttr(org.safris.web.depiction.schema.xhtml.strict.IURI<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		public CiteAttr(java.lang.String value)
		{
			super(value);
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Del.CiteAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Del.CiteAttr(this);
		}
	...
	*/
	...
	public static class DatetimeAttr extends org.safris.web.depiction.schema.xhtml.strict.IDatetime<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "datetime");

		public DatetimeAttr(org.safris.web.depiction.schema.xhtml.strict.IDatetime<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		public DatetimeAttr(org.safris.xml.bind.runtime.types.lang.DateTime value)
		{
			super(value);
		}

		protected DatetimeAttr(java.lang.String value)
		{
			super(value);
		}

		protected DatetimeAttr()
		{
			super();
		}

		public org.safris.xml.bind.runtime.types.lang.DateTime getValue()
		{
			return super.getTEXT();
		}

		public void setValue(org.safris.xml.bind.runtime.types.lang.DateTime value)
		{
			super.setTEXT(value);
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Del.DatetimeAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Del.DatetimeAttr(this);
		}
