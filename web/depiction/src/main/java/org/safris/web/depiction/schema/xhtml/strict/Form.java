...
public class Form extends org.safris.web.depiction.schema.xhtml.strict.IFormContent<org.safris.xml.bind.runtime.lang.ComplexType>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "form");

	static
	{
		getElementBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.Form.class.getName());
	}

	private org.safris.web.depiction.schema.xhtml.strict.Form.ActionAttr _actionAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Form.MethodAttr _methodAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Form.EnctypeAttr _enctypeAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Form.OnsubmitAttr _onsubmitAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Form.OnresetAttr _onresetAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Form.AcceptAttr _acceptAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Form.AcceptCharsetAttr _acceptCharsetAttr = null;
	...
	public Form(org.safris.web.depiction.schema.xhtml.strict.IFormContent<org.safris.xml.bind.runtime.lang.ComplexType> binding)
	{
		super(binding);
		if(binding instanceof org.safris.web.depiction.schema.xhtml.strict.Form)
		{
			org.safris.web.depiction.schema.xhtml.strict.Form element = (org.safris.web.depiction.schema.xhtml.strict.Form)binding;
			this._actionAttr = element._actionAttr != null ? element._actionAttr.clone() : null;
			this._methodAttr = element._methodAttr != null ? element._methodAttr.clone() : null;
			this._enctypeAttr = element._enctypeAttr != null ? element._enctypeAttr.clone() : null;
			this._onsubmitAttr = element._onsubmitAttr != null ? element._onsubmitAttr.clone() : null;
			this._onresetAttr = element._onresetAttr != null ? element._onresetAttr.clone() : null;
			this._acceptAttr = element._acceptAttr != null ? element._acceptAttr.clone() : null;
			this._acceptCharsetAttr = element._acceptCharsetAttr != null ? element._acceptCharsetAttr.clone() : null;
	...
	public void setActionAttr(org.safris.web.depiction.schema.xhtml.strict.Form.ActionAttr _actionAttr)
	{
		this._actionAttr = _actionAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Form.ActionAttr getActionAttr()
	{
		return _actionAttr;
	}

	public void setMethodAttr(org.safris.web.depiction.schema.xhtml.strict.Form.MethodAttr _methodAttr)
	{
		this._methodAttr = _methodAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Form.MethodAttr getMethodAttr()
	{
		return _methodAttr;
	}

	public void setEnctypeAttr(org.safris.web.depiction.schema.xhtml.strict.Form.EnctypeAttr _enctypeAttr)
	{
		this._enctypeAttr = _enctypeAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Form.EnctypeAttr getEnctypeAttr()
	{
		return _enctypeAttr;
	}

	public void setOnsubmitAttr(org.safris.web.depiction.schema.xhtml.strict.Form.OnsubmitAttr _onsubmitAttr)
	{
		this._onsubmitAttr = _onsubmitAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Form.OnsubmitAttr getOnsubmitAttr()
	{
		return _onsubmitAttr;
	}

	public void setOnresetAttr(org.safris.web.depiction.schema.xhtml.strict.Form.OnresetAttr _onresetAttr)
	{
		this._onresetAttr = _onresetAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Form.OnresetAttr getOnresetAttr()
	{
		return _onresetAttr;
	}

	public void setAcceptAttr(org.safris.web.depiction.schema.xhtml.strict.Form.AcceptAttr _acceptAttr)
	{
		this._acceptAttr = _acceptAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Form.AcceptAttr getAcceptAttr()
	{
		return _acceptAttr;
	}

	public void setAcceptCharsetAttr(org.safris.web.depiction.schema.xhtml.strict.Form.AcceptCharsetAttr _acceptCharsetAttr)
	{
		this._acceptCharsetAttr = _acceptCharsetAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Form.AcceptCharsetAttr getAcceptCharsetAttr()
	{
		return _acceptCharsetAttr;
	}
	...
	protected org.w3c.dom.Element marshal(org.w3c.dom.Element parent, javax.xml.namespace.QName name, javax.xml.namespace.QName typeName) throws org.safris.xml.bind.runtime.lang.MarshalException
	{
		...
		if(_actionAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_actionAttr, "action", element));
		}

		if(_methodAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_methodAttr, "method", element));
		}

		if(_enctypeAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_enctypeAttr, "enctype", element));
		}

		if(_onsubmitAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_onsubmitAttr, "onsubmit", element));
		}

		if(_onresetAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_onresetAttr, "onreset", element));
		}
		...
		if(_acceptCharsetAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_acceptCharsetAttr, "accept-charset", element));
		}
	...
	protected void parse(org.w3c.dom.Element element) throws org.safris.xml.bind.runtime.lang.UnmarshalException, org.safris.xml.bind.runtime.lang.ValidationException
	{
		...
		for(int i = 0; i < namedNodeMap.getLength(); i++)
		{
			...
			else if("action".equals(attribute.getLocalName()))
			{
				this._actionAttr = (org.safris.web.depiction.schema.xhtml.strict.Form.ActionAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Form.ActionAttr.class, element, attribute);
			}
			else if("method".equals(attribute.getLocalName()))
			{
				this._methodAttr = (org.safris.web.depiction.schema.xhtml.strict.Form.MethodAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Form.MethodAttr.class, element, attribute);
			}
			else if("enctype".equals(attribute.getLocalName()))
			{
				this._enctypeAttr = (org.safris.web.depiction.schema.xhtml.strict.Form.EnctypeAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Form.EnctypeAttr.class, element, attribute);
			}
			else if("onsubmit".equals(attribute.getLocalName()))
			{
				this._onsubmitAttr = (org.safris.web.depiction.schema.xhtml.strict.Form.OnsubmitAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Form.OnsubmitAttr.class, element, attribute);
			}
			else if("onreset".equals(attribute.getLocalName()))
			{
				this._onresetAttr = (org.safris.web.depiction.schema.xhtml.strict.Form.OnresetAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Form.OnresetAttr.class, element, attribute);
			}
			else if("accept".equals(attribute.getLocalName()))
			{
				this._acceptAttr = (org.safris.web.depiction.schema.xhtml.strict.Form.AcceptAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Form.AcceptAttr.class, element, attribute);
			}
			else if("accept-charset".equals(attribute.getLocalName()))
			{
				this._acceptCharsetAttr = (org.safris.web.depiction.schema.xhtml.strict.Form.AcceptCharsetAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Form.AcceptCharsetAttr.class, element, attribute);
			}
	...
	public org.safris.web.depiction.schema.xhtml.strict.Form clone()
	{
		return new org.safris.web.depiction.schema.xhtml.strict.Form(this);
	}
	...
	public boolean equals(java.lang.Object obj)
	{
		...
		if(!(obj instanceof org.safris.web.depiction.schema.xhtml.strict.Form))
			return false;

		org.safris.web.depiction.schema.xhtml.strict.Form binding = (org.safris.web.depiction.schema.xhtml.strict.Form)obj;
		if((this._actionAttr == null && binding._actionAttr != null) || (this._actionAttr != null && !this._actionAttr.equals(binding._actionAttr)))
			return false;

		if((this._methodAttr == null && binding._methodAttr != null) || (this._methodAttr != null && !this._methodAttr.equals(binding._methodAttr)))
			return false;

		if((this._enctypeAttr == null && binding._enctypeAttr != null) || (this._enctypeAttr != null && !this._enctypeAttr.equals(binding._enctypeAttr)))
			return false;

		if((this._onsubmitAttr == null && binding._onsubmitAttr != null) || (this._onsubmitAttr != null && !this._onsubmitAttr.equals(binding._onsubmitAttr)))
			return false;

		if((this._onresetAttr == null && binding._onresetAttr != null) || (this._onresetAttr != null && !this._onresetAttr.equals(binding._onresetAttr)))
			return false;

		if((this._acceptAttr == null && binding._acceptAttr != null) || (this._acceptAttr != null && !this._acceptAttr.equals(binding._acceptAttr)))
			return false;

		if((this._acceptCharsetAttr == null && binding._acceptCharsetAttr != null) || (this._acceptCharsetAttr != null && !this._acceptCharsetAttr.equals(binding._acceptCharsetAttr)))
			return false;
	...
	public int hashCode()
	{
		...
		stringBuffer.append(_actionAttr != null ? _actionAttr.hashCode() : 0).append("-");
		stringBuffer.append(_methodAttr != null ? _methodAttr.hashCode() : 0).append("-");
		stringBuffer.append(_enctypeAttr != null ? _enctypeAttr.hashCode() : 0).append("-");
		stringBuffer.append(_onsubmitAttr != null ? _onsubmitAttr.hashCode() : 0).append("-");
		stringBuffer.append(_onresetAttr != null ? _onresetAttr.hashCode() : 0).append("-");
		stringBuffer.append(_acceptAttr != null ? _acceptAttr.hashCode() : 0).append("-");
		stringBuffer.append(_acceptCharsetAttr != null ? _acceptCharsetAttr.hashCode() : 0).append("-");
	...
	*/
	...
	public static class ActionAttr extends org.safris.web.depiction.schema.xhtml.strict.IURI<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "action");

		public ActionAttr(org.safris.web.depiction.schema.xhtml.strict.IURI<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		public ActionAttr(java.lang.String value)
		{
			super(value);
		}

		protected ActionAttr()
		{
			super();
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Form.ActionAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Form.ActionAttr(this);
		}
	...
	*/
	...
	public static class MethodAttr extends org.safris.xml.bind.runtime.types.TokenType<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "method");

		protected MethodAttr(org.safris.xml.bind.runtime.types.TokenType<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		protected MethodAttr(java.lang.String value)
		{
			super(value);
		}
		...
		public static final RESTRICTION GET = new RESTRICTION("get");
		public static final RESTRICTION POST = new RESTRICTION("post");

		public MethodAttr(RESTRICTION restriction)
		{
			super(restriction.value);
		}

		protected MethodAttr()
		{
			super();
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Form.MethodAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Form.MethodAttr(this);
		}
	...
	*/
	...
	public static class EnctypeAttr extends org.safris.web.depiction.schema.xhtml.strict.IContentType<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "enctype");

		public EnctypeAttr(org.safris.web.depiction.schema.xhtml.strict.IContentType<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		public EnctypeAttr(java.lang.String value)
		{
			super(value);
		}

		protected EnctypeAttr()
		{
			super();
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Form.EnctypeAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Form.EnctypeAttr(this);
		}
	...
	*/
	...
	public static class OnsubmitAttr extends org.safris.web.depiction.schema.xhtml.strict.IScript<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "onsubmit");

		public OnsubmitAttr(org.safris.web.depiction.schema.xhtml.strict.IScript<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		public OnsubmitAttr(java.lang.String value)
		{
			super(value);
		}

		protected OnsubmitAttr()
		{
			super();
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Form.OnsubmitAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Form.OnsubmitAttr(this);
		}
	...
	*/
	...
	public static class OnresetAttr extends org.safris.web.depiction.schema.xhtml.strict.IScript<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "onreset");

		public OnresetAttr(org.safris.web.depiction.schema.xhtml.strict.IScript<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		public OnresetAttr(java.lang.String value)
		{
			super(value);
		}

		protected OnresetAttr()
		{
			super();
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Form.OnresetAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Form.OnresetAttr(this);
		}
	...
	*/
	...
	public static class AcceptAttr extends org.safris.web.depiction.schema.xhtml.strict.IContentTypes<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Form.AcceptAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Form.AcceptAttr(this);
		}
	...
	*/
	...
	public static class AcceptCharsetAttr extends org.safris.web.depiction.schema.xhtml.strict.ICharsets<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "accept-charset");

		public AcceptCharsetAttr(org.safris.web.depiction.schema.xhtml.strict.ICharsets<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		public AcceptCharsetAttr(java.lang.String value)
		{
			super(value);
		}

		protected AcceptCharsetAttr()
		{
			super();
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Form.AcceptCharsetAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Form.AcceptCharsetAttr(this);
		}
