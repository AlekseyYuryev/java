 ...
 * 
 *  a) for document specific toolbars/menus when used with the link element in
 * document head e.g. start, contents, previous, next, index, end, help b) to
 * link to a separate style sheet (rel="stylesheet") c) to make a link to a script
 * (rel="script") d) by stylesheets to control how collections of html nodes
 * are rendered into printed documents e) to make a link to a printable version
 * of this document e.g. a PostScript or PDF version (rel="alternate" media="print")
 *
 * @author Source generated with: <u>xml Bind for Java</u> by <b>Seva Safris &lt;seva@safris.org&gt;</b>
 */

public class Link extends org.safris.xml.bind.runtime.lang.Binding<org.safris.xml.bind.runtime.lang.ComplexType>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "link");

	static
	{
		getElementBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.Link.class.getName());
	}

	private org.safris.web.depiction.schema.xhtml.strict.Link.CharsetAttr _charsetAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Link.HrefAttr _hrefAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Link.HreflangAttr _hreflangAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Link.TypeAttr _typeAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Link.RelAttr _relAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Link.RevAttr _revAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Link.MediaAttr _mediaAttr = null;
	...
	public Link(org.safris.web.depiction.schema.xhtml.strict.Link binding)
	{
		super(binding);
		if(binding instanceof org.safris.web.depiction.schema.xhtml.strict.Link)
		{
			org.safris.web.depiction.schema.xhtml.strict.Link element = (org.safris.web.depiction.schema.xhtml.strict.Link)binding;
	...
	public void setCharsetAttr(org.safris.web.depiction.schema.xhtml.strict.Link.CharsetAttr _charsetAttr)
	{
		this._charsetAttr = _charsetAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Link.CharsetAttr getCharsetAttr()
	{
		return _charsetAttr;
	}

	public void setHrefAttr(org.safris.web.depiction.schema.xhtml.strict.Link.HrefAttr _hrefAttr)
	{
		this._hrefAttr = _hrefAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Link.HrefAttr getHrefAttr()
	{
		return _hrefAttr;
	}

	public void setHreflangAttr(org.safris.web.depiction.schema.xhtml.strict.Link.HreflangAttr _hreflangAttr)
	{
		this._hreflangAttr = _hreflangAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Link.HreflangAttr getHreflangAttr()
	{
		return _hreflangAttr;
	}

	public void setTypeAttr(org.safris.web.depiction.schema.xhtml.strict.Link.TypeAttr _typeAttr)
	{
		this._typeAttr = _typeAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Link.TypeAttr getTypeAttr()
	{
		return _typeAttr;
	}

	public void setRelAttr(org.safris.web.depiction.schema.xhtml.strict.Link.RelAttr _relAttr)
	{
		this._relAttr = _relAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Link.RelAttr getRelAttr()
	{
		return _relAttr;
	}

	public void setRevAttr(org.safris.web.depiction.schema.xhtml.strict.Link.RevAttr _revAttr)
	{
		this._revAttr = _revAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Link.RevAttr getRevAttr()
	{
		return _revAttr;
	}

	public void setMediaAttr(org.safris.web.depiction.schema.xhtml.strict.Link.MediaAttr _mediaAttr)
	{
		this._mediaAttr = _mediaAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Link.MediaAttr getMediaAttr()
	{
		return _mediaAttr;
	}
	...
	protected void parse(org.w3c.dom.Element element) throws org.safris.xml.bind.runtime.lang.UnmarshalException, org.safris.xml.bind.runtime.lang.ValidationException
	{
		...
		for(int i = 0; i < namedNodeMap.getLength(); i++)
		{
			...
			{
				this._charsetAttr = (org.safris.web.depiction.schema.xhtml.strict.Link.CharsetAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Link.CharsetAttr.class, element, attribute);
			}
			else if("href".equals(attribute.getLocalName()))
			{
				this._hrefAttr = (org.safris.web.depiction.schema.xhtml.strict.Link.HrefAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Link.HrefAttr.class, element, attribute);
			}
			else if("hreflang".equals(attribute.getLocalName()))
			{
				this._hreflangAttr = (org.safris.web.depiction.schema.xhtml.strict.Link.HreflangAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Link.HreflangAttr.class, element, attribute);
			}
			else if("type".equals(attribute.getLocalName()))
			{
				this._typeAttr = (org.safris.web.depiction.schema.xhtml.strict.Link.TypeAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Link.TypeAttr.class, element, attribute);
			}
			else if("rel".equals(attribute.getLocalName()))
			{
				this._relAttr = (org.safris.web.depiction.schema.xhtml.strict.Link.RelAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Link.RelAttr.class, element, attribute);
			}
			else if("rev".equals(attribute.getLocalName()))
			{
				this._revAttr = (org.safris.web.depiction.schema.xhtml.strict.Link.RevAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Link.RevAttr.class, element, attribute);
			}
			else if("media".equals(attribute.getLocalName()))
			{
				this._mediaAttr = (org.safris.web.depiction.schema.xhtml.strict.Link.MediaAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Link.MediaAttr.class, element, attribute);
			}
	...
	public org.safris.web.depiction.schema.xhtml.strict.Link clone()
	{
		return new org.safris.web.depiction.schema.xhtml.strict.Link(this);
	}
	...
	public boolean equals(java.lang.Object obj)
	{
		...
		if(!(obj instanceof org.safris.web.depiction.schema.xhtml.strict.Link))
			return false;

		org.safris.web.depiction.schema.xhtml.strict.Link binding = (org.safris.web.depiction.schema.xhtml.strict.Link)obj;
	...
	*/
	...
	public static class CharsetAttr extends org.safris.web.depiction.schema.xhtml.strict.ICharset<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Link.CharsetAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Link.CharsetAttr(this);
		}
	...
	*/
	...
	public static class HrefAttr extends org.safris.web.depiction.schema.xhtml.strict.IURI<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Link.HrefAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Link.HrefAttr(this);
		}
	...
	*/
	...
	public static class HreflangAttr extends org.safris.web.depiction.schema.xhtml.strict.ILanguageCode<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Link.HreflangAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Link.HreflangAttr(this);
		}
	...
	*/
	...
	public static class TypeAttr extends org.safris.web.depiction.schema.xhtml.strict.IContentType<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Link.TypeAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Link.TypeAttr(this);
		}
	...
	*/
	...
	public static class RelAttr extends org.safris.web.depiction.schema.xhtml.strict.ILinkTypes<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Link.RelAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Link.RelAttr(this);
		}
	...
	*/
	...
	public static class RevAttr extends org.safris.web.depiction.schema.xhtml.strict.ILinkTypes<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Link.RevAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Link.RevAttr(this);
		}
	...
	*/
	...
	public static class MediaAttr extends org.safris.web.depiction.schema.xhtml.strict.IMediaDesc<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Link.MediaAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Link.MediaAttr(this);
		}
