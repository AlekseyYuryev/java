...
public abstract class ICoords<T extends org.safris.xml.bind.runtime.lang.BindingType> extends org.safris.xml.bind.runtime.types.StringType<T>
{
  ...
  protected static ICoords newInstance(final javax.xml.namespace.QName name)
  {
    return new ICoords()
    {
  ...
  static
  {
    getTypeBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.ICoords.class.getName());
  }

  protected ICoords(org.safris.xml.bind.runtime.types.StringType binding)
  {
    super(binding);
  }

  protected ICoords(java.lang.String value)
  {
    super(value);
  }
  ...
  public org.safris.web.depiction.schema.xhtml.strict.ICoords clone()
  {
    return new org.safris.web.depiction.schema.xhtml.strict.ICoords(this)
    {
      protected javax.xml.namespace.QName _getName()
      {
        return _getName();
