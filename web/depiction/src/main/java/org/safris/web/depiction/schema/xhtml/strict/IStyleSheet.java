...
public abstract class IStyleSheet<T extends org.safris.xml.bind.runtime.lang.BindingType> extends org.safris.xml.bind.runtime.types.StringType<T>
{
  private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "StyleSheet");

  protected static IStyleSheet newInstance(final javax.xml.namespace.QName name)
  {
  ...
  static
  {
    getTypeBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.IStyleSheet.class.getName());
  }

  protected IStyleSheet(org.safris.xml.bind.runtime.types.StringType binding)
  {
    super(binding);
  }

  protected IStyleSheet(java.lang.String value)
  {
    super(value);
  }
  ...
  public org.safris.web.depiction.schema.xhtml.strict.IStyleSheet clone()
  {
    return new org.safris.web.depiction.schema.xhtml.strict.IStyleSheet(this)
    {
      protected javax.xml.namespace.QName _getName()
      {
        return _getName();
