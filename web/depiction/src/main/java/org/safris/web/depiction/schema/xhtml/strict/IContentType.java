...
public abstract class IContentType<T extends org.safris.xml.bind.runtime.lang.BindingType> extends org.safris.xml.bind.runtime.types.StringType<T>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "ContentType");

	protected static IContentType newInstance(final javax.xml.namespace.QName name)
	{
	...
	static
	{
		getTypeBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.IContentType.class.getName());
	}

	protected IContentType(org.safris.xml.bind.runtime.types.StringType binding)
	{
		super(binding);
	}

	protected IContentType(java.lang.String value)
	{
		super(value);
	}
	...
	public org.safris.web.depiction.schema.xhtml.strict.IContentType clone()
	{
		return new org.safris.web.depiction.schema.xhtml.strict.IContentType(this)
		{
			protected javax.xml.namespace.QName _getName()
			{
				return _getName();
