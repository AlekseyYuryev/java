...
public abstract class ILength<T extends org.safris.xml.bind.runtime.lang.BindingType> extends org.safris.xml.bind.runtime.types.StringType<T>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "Length");
	private static java.lang.String[] patterns = new java.lang.String[]
	{"[-+]?(\\d+|\\d+(\\.\\d+)?%)"
	};

	protected static ILength newInstance(final javax.xml.namespace.QName name)
	{
		return new ILength()
		{
	...
	static
	{
		getTypeBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.ILength.class.getName());
	}

	protected ILength(org.safris.xml.bind.runtime.types.StringType binding)
	{
		super(binding);
	}

	protected ILength(java.lang.String value)
	{
		super(value);
	}
	...
	public org.safris.web.depiction.schema.xhtml.strict.ILength clone()
	{
		return new org.safris.web.depiction.schema.xhtml.strict.ILength(this)
		{
			protected javax.xml.namespace.QName _getName()
			{
				return _getName();
