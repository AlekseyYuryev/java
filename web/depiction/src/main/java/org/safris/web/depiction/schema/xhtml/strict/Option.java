...
public class Option extends org.safris.xml.bind.runtime.lang.Binding<org.safris.xml.bind.runtime.lang.ComplexType>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "option");

	static
	{
		getElementBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.Option.class.getName());
	}

	private org.safris.web.depiction.schema.xhtml.strict.Option.SelectedAttr _selectedAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Option.DisabledAttr _disabledAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Option.LabelAttr _labelAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Option.ValueAttr _valueAttr = null;
	...
	public Option(org.safris.web.depiction.schema.xhtml.strict.Option binding)
	{
		super(binding);
		if(binding instanceof org.safris.web.depiction.schema.xhtml.strict.Option)
		{
			org.safris.web.depiction.schema.xhtml.strict.Option element = (org.safris.web.depiction.schema.xhtml.strict.Option)binding;
			this._selectedAttr = element._selectedAttr != null ? element._selectedAttr.clone() : null;
			this._disabledAttr = element._disabledAttr != null ? element._disabledAttr.clone() : null;
			this._labelAttr = element._labelAttr != null ? element._labelAttr.clone() : null;
	...
	public void setSelectedAttr(org.safris.web.depiction.schema.xhtml.strict.Option.SelectedAttr _selectedAttr)
	{
		this._selectedAttr = _selectedAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Option.SelectedAttr getSelectedAttr()
	{
		return _selectedAttr;
	}

	public void setDisabledAttr(org.safris.web.depiction.schema.xhtml.strict.Option.DisabledAttr _disabledAttr)
	{
		this._disabledAttr = _disabledAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Option.DisabledAttr getDisabledAttr()
	{
		return _disabledAttr;
	}

	public void setLabelAttr(org.safris.web.depiction.schema.xhtml.strict.Option.LabelAttr _labelAttr)
	{
		this._labelAttr = _labelAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Option.LabelAttr getLabelAttr()
	{
		return _labelAttr;
	}

	public void setValueAttr(org.safris.web.depiction.schema.xhtml.strict.Option.ValueAttr _valueAttr)
	{
		this._valueAttr = _valueAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Option.ValueAttr getValueAttr()
	{
		return _valueAttr;
	}
	...
	protected org.w3c.dom.Element marshal(org.w3c.dom.Element parent, javax.xml.namespace.QName name, javax.xml.namespace.QName typeName) throws org.safris.xml.bind.runtime.lang.MarshalException
	{
		...
		if(_selectedAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_selectedAttr, "selected", element));
		}
		...
		if(_labelAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_labelAttr, "label", element));
		}
	...
	protected void parse(org.w3c.dom.Element element) throws org.safris.xml.bind.runtime.lang.UnmarshalException, org.safris.xml.bind.runtime.lang.ValidationException
	{
		...
		for(int i = 0; i < namedNodeMap.getLength(); i++)
		{
			...
			else if("selected".equals(attribute.getLocalName()))
			{
				this._selectedAttr = (org.safris.web.depiction.schema.xhtml.strict.Option.SelectedAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Option.SelectedAttr.class, element, attribute);
			}
			else if("disabled".equals(attribute.getLocalName()))
			{
				this._disabledAttr = (org.safris.web.depiction.schema.xhtml.strict.Option.DisabledAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Option.DisabledAttr.class, element, attribute);
			}
			else if("label".equals(attribute.getLocalName()))
			{
				this._labelAttr = (org.safris.web.depiction.schema.xhtml.strict.Option.LabelAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Option.LabelAttr.class, element, attribute);
			}
			else if("value".equals(attribute.getLocalName()))
			{
				this._valueAttr = (org.safris.web.depiction.schema.xhtml.strict.Option.ValueAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Option.ValueAttr.class, element, attribute);
			}
	...
	public org.safris.web.depiction.schema.xhtml.strict.Option clone()
	{
		return new org.safris.web.depiction.schema.xhtml.strict.Option(this);
	}
	...
	public boolean equals(java.lang.Object obj)
	{
		...
		if(!(obj instanceof org.safris.web.depiction.schema.xhtml.strict.Option))
			return false;

		org.safris.web.depiction.schema.xhtml.strict.Option binding = (org.safris.web.depiction.schema.xhtml.strict.Option)obj;
		if((this._selectedAttr == null && binding._selectedAttr != null) || (this._selectedAttr != null && !this._selectedAttr.equals(binding._selectedAttr)))
			return false;
		...
		if((this._labelAttr == null && binding._labelAttr != null) || (this._labelAttr != null && !this._labelAttr.equals(binding._labelAttr)))
			return false;
	...
	public int hashCode()
	{
		...
		stringBuffer.append(_selectedAttr != null ? _selectedAttr.hashCode() : 0).append("-");
		stringBuffer.append(_disabledAttr != null ? _disabledAttr.hashCode() : 0).append("-");
		stringBuffer.append(_labelAttr != null ? _labelAttr.hashCode() : 0).append("-");
	...
	*/
	...
	public static class SelectedAttr extends org.safris.xml.bind.runtime.types.TokenType<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "selected");

		protected SelectedAttr(org.safris.xml.bind.runtime.types.TokenType<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		protected SelectedAttr(java.lang.String value)
		{
			super(value);
		}
		...
		public static final RESTRICTION SELECTED = new RESTRICTION("selected");

		public SelectedAttr(RESTRICTION restriction)
		{
			super(restriction.value);
		}

		protected SelectedAttr()
		{
			super();
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Option.SelectedAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Option.SelectedAttr(this);
		}
	...
	*/
	...
	public static class DisabledAttr extends org.safris.xml.bind.runtime.types.TokenType<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Option.DisabledAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Option.DisabledAttr(this);
		}
	...
	*/
	...
	public static class LabelAttr extends org.safris.web.depiction.schema.xhtml.strict.IText<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "label");

		public LabelAttr(org.safris.web.depiction.schema.xhtml.strict.IText<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		public LabelAttr(java.lang.String value)
		{
			super(value);
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Option.LabelAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Option.LabelAttr(this);
		}
	...
	*/
	...
	public static class ValueAttr extends org.safris.xml.bind.runtime.types.StringType<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Option.ValueAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Option.ValueAttr(this);
		}
