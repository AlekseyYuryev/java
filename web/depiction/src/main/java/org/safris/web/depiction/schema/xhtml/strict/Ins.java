...
public class Ins extends org.safris.web.depiction.schema.xhtml.strict.IFlow<org.safris.xml.bind.runtime.lang.ComplexType>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "ins");

	static
	{
		getElementBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.Ins.class.getName());
	}

	private java.lang.String text = null;
	private org.safris.web.depiction.schema.xhtml.strict.Ins.CiteAttr _citeAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Ins.DatetimeAttr _datetimeAttr = null;
	...
	public Ins(java.lang.String text)
	{
		super(text);
	}

	public Ins(org.safris.web.depiction.schema.xhtml.strict.IFlow<org.safris.xml.bind.runtime.lang.ComplexType> binding)
	{
		super(binding);
		if(binding instanceof org.safris.web.depiction.schema.xhtml.strict.Ins)
		{
			org.safris.web.depiction.schema.xhtml.strict.Ins element = (org.safris.web.depiction.schema.xhtml.strict.Ins)binding;
	...
	public void setCiteAttr(org.safris.web.depiction.schema.xhtml.strict.Ins.CiteAttr _citeAttr)
	{
		this._citeAttr = _citeAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Ins.CiteAttr getCiteAttr()
	{
		return _citeAttr;
	}

	public void setDatetimeAttr(org.safris.web.depiction.schema.xhtml.strict.Ins.DatetimeAttr _datetimeAttr)
	{
		this._datetimeAttr = _datetimeAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Ins.DatetimeAttr getDatetimeAttr()
	{
	...
	protected void parse(org.w3c.dom.Element element) throws org.safris.xml.bind.runtime.lang.UnmarshalException, org.safris.xml.bind.runtime.lang.ValidationException
	{
		...
		for(int i = 0; i < namedNodeMap.getLength(); i++)
		{
			...
			{
				this._citeAttr = (org.safris.web.depiction.schema.xhtml.strict.Ins.CiteAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Ins.CiteAttr.class, element, attribute);
			}
			else if("datetime".equals(attribute.getLocalName()))
			{
				this._datetimeAttr = (org.safris.web.depiction.schema.xhtml.strict.Ins.DatetimeAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Ins.DatetimeAttr.class, element, attribute);
			}
	...
	public org.safris.web.depiction.schema.xhtml.strict.Ins clone()
	{
		return new org.safris.web.depiction.schema.xhtml.strict.Ins(this);
	}
	...
	public boolean equals(java.lang.Object obj)
	{
		...
		if(!(obj instanceof org.safris.web.depiction.schema.xhtml.strict.Ins))
			return false;

		org.safris.web.depiction.schema.xhtml.strict.Ins binding = (org.safris.web.depiction.schema.xhtml.strict.Ins)obj;
	...
	*/
	...
	public static class CiteAttr extends org.safris.web.depiction.schema.xhtml.strict.IURI<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Ins.CiteAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Ins.CiteAttr(this);
		}
	...
	*/
	...
	public static class DatetimeAttr extends org.safris.web.depiction.schema.xhtml.strict.IDatetime<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Ins.DatetimeAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Ins.DatetimeAttr(this);
		}
