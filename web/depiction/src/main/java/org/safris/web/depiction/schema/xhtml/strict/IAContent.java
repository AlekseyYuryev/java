...
public abstract class IAContent<T extends org.safris.xml.bind.runtime.lang.ComplexType> extends org.safris.xml.bind.runtime.lang.Binding<T>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "a.content");

	protected static IAContent newInstance(final javax.xml.namespace.QName name)
	{
		return new IAContent()
		{
	...
	static
	{
		getTypeBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.IAContent.class.getName());
	}
	...
	public IAContent(org.safris.web.depiction.schema.xhtml.strict.IAContent binding)
	{
		super(binding);
	...
	public IAContent(java.lang.String text)
	{
		this.text = text;
	}
	...
	public org.safris.web.depiction.schema.xhtml.strict.IAContent clone()
	{
		return org.safris.web.depiction.schema.xhtml.strict.IAContent.newInstance(this._getName());
	}
	...
	public boolean equals(java.lang.Object obj)
	{
		...
		if(!(obj instanceof org.safris.web.depiction.schema.xhtml.strict.IAContent))
			return false;

		org.safris.web.depiction.schema.xhtml.strict.IAContent binding = (org.safris.web.depiction.schema.xhtml.strict.IAContent)obj;
