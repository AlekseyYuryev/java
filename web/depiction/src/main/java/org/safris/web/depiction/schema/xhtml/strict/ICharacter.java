...
public abstract class ICharacter<T extends org.safris.xml.bind.runtime.lang.BindingType> extends org.safris.xml.bind.runtime.types.StringType<T>
{
  private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "Character");

  protected static ICharacter newInstance(final javax.xml.namespace.QName name)
  {
  ...
  static
  {
    getTypeBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.ICharacter.class.getName());
  }

  protected ICharacter(org.safris.xml.bind.runtime.types.StringType binding)
  {
    super(binding);
  }

  protected ICharacter(java.lang.String value)
  {
    super(value);
  }
  ...
  public org.safris.web.depiction.schema.xhtml.strict.ICharacter clone()
  {
    return new org.safris.web.depiction.schema.xhtml.strict.ICharacter(this)
    {
      protected javax.xml.namespace.QName _getName()
      {
        return _getName();
