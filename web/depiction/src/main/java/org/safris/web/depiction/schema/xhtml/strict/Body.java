...
public class Body extends org.safris.web.depiction.schema.xhtml.strict.IBlock<org.safris.xml.bind.runtime.lang.ComplexType>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "body");

	static
	{
		getElementBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.Body.class.getName());
	}

	private org.safris.web.depiction.schema.xhtml.strict.Body.OnloadAttr _onloadAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Body.OnunloadAttr _onunloadAttr = null;
	...
	public Body(org.safris.web.depiction.schema.xhtml.strict.IBlock<org.safris.xml.bind.runtime.lang.ComplexType> binding)
	{
		super(binding);
		if(binding instanceof org.safris.web.depiction.schema.xhtml.strict.Body)
		{
			org.safris.web.depiction.schema.xhtml.strict.Body element = (org.safris.web.depiction.schema.xhtml.strict.Body)binding;
			this._onloadAttr = element._onloadAttr != null ? element._onloadAttr.clone() : null;
			this._onunloadAttr = element._onunloadAttr != null ? element._onunloadAttr.clone() : null;
	...
	public void setOnloadAttr(org.safris.web.depiction.schema.xhtml.strict.Body.OnloadAttr _onloadAttr)
	{
		this._onloadAttr = _onloadAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Body.OnloadAttr getOnloadAttr()
	{
		return _onloadAttr;
	}

	public void setOnunloadAttr(org.safris.web.depiction.schema.xhtml.strict.Body.OnunloadAttr _onunloadAttr)
	{
		this._onunloadAttr = _onunloadAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Body.OnunloadAttr getOnunloadAttr()
	{
		return _onunloadAttr;
	}
	...
	protected org.w3c.dom.Element marshal(org.w3c.dom.Element parent, javax.xml.namespace.QName name, javax.xml.namespace.QName typeName) throws org.safris.xml.bind.runtime.lang.MarshalException
	{
		...
		if(_onloadAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_onloadAttr, "onload", element));
		}

		if(_onunloadAttr != null)
		{
			element.setAttributeNodeNS(org.safris.xml.bind.runtime.lang.Binding.marshalAttr(_onunloadAttr, "onunload", element));
		}
	...
	protected void parse(org.w3c.dom.Element element) throws org.safris.xml.bind.runtime.lang.UnmarshalException, org.safris.xml.bind.runtime.lang.ValidationException
	{
		...
		for(int i = 0; i < namedNodeMap.getLength(); i++)
		{
			...
			else if("onload".equals(attribute.getLocalName()))
			{
				this._onloadAttr = (org.safris.web.depiction.schema.xhtml.strict.Body.OnloadAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Body.OnloadAttr.class, element, attribute);
			}
			else if("onunload".equals(attribute.getLocalName()))
			{
				this._onunloadAttr = (org.safris.web.depiction.schema.xhtml.strict.Body.OnunloadAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Body.OnunloadAttr.class, element, attribute);
			}
	...
	public org.safris.web.depiction.schema.xhtml.strict.Body clone()
	{
		return new org.safris.web.depiction.schema.xhtml.strict.Body(this);
	}
	...
	public boolean equals(java.lang.Object obj)
	{
		...
		if(!(obj instanceof org.safris.web.depiction.schema.xhtml.strict.Body))
			return false;

		org.safris.web.depiction.schema.xhtml.strict.Body binding = (org.safris.web.depiction.schema.xhtml.strict.Body)obj;
		if((this._onloadAttr == null && binding._onloadAttr != null) || (this._onloadAttr != null && !this._onloadAttr.equals(binding._onloadAttr)))
			return false;

		if((this._onunloadAttr == null && binding._onunloadAttr != null) || (this._onunloadAttr != null && !this._onunloadAttr.equals(binding._onunloadAttr)))
			return false;
	...
	public int hashCode()
	{
		...
		stringBuffer.append(_onloadAttr != null ? _onloadAttr.hashCode() : 0).append("-");
		stringBuffer.append(_onunloadAttr != null ? _onunloadAttr.hashCode() : 0).append("-");
	...
	*/
	...
	public static class OnloadAttr extends org.safris.web.depiction.schema.xhtml.strict.IScript<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "onload");

		public OnloadAttr(org.safris.web.depiction.schema.xhtml.strict.IScript<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		public OnloadAttr(java.lang.String value)
		{
			super(value);
		}

		protected OnloadAttr()
		{
			super();
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Body.OnloadAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Body.OnloadAttr(this);
		}
	...
	*/
	...
	public static class OnunloadAttr extends org.safris.web.depiction.schema.xhtml.strict.IScript<org.safris.xml.bind.runtime.lang.Attribute>
	{
		private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "onunload");

		public OnunloadAttr(org.safris.web.depiction.schema.xhtml.strict.IScript<org.safris.xml.bind.runtime.lang.Attribute> binding)
		{
			super(binding);
		}

		public OnunloadAttr(java.lang.String value)
		{
			super(value);
		}

		protected OnunloadAttr()
		{
			super();
		}
		...
		public org.safris.web.depiction.schema.xhtml.strict.Body.OnunloadAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Body.OnunloadAttr(this);
		}
