...
public abstract class IMediaDesc<T extends org.safris.xml.bind.runtime.lang.BindingType> extends org.safris.xml.bind.runtime.types.StringType<T>
{
  private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "MediaDesc");
  private static java.lang.String[] patterns = new java.lang.String[]
  {"[^,]+(,\\s*[^,]+)*"
  };

  protected static IMediaDesc newInstance(final javax.xml.namespace.QName name)
  {
    return new IMediaDesc()
    {
  ...
  static
  {
    getTypeBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.IMediaDesc.class.getName());
  }

  protected IMediaDesc(org.safris.xml.bind.runtime.types.StringType binding)
  {
    super(binding);
  }

  protected IMediaDesc(java.lang.String value)
  {
    super(value);
  }

  protected IMediaDesc()
  {
    super();
  }
  ...
  public org.safris.web.depiction.schema.xhtml.strict.IMediaDesc clone()
  {
    return new org.safris.web.depiction.schema.xhtml.strict.IMediaDesc(this)
    {
      protected javax.xml.namespace.QName _getName()
      {
        return _getName();
