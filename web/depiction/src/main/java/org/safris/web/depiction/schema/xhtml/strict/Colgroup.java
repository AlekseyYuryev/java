...
/**
 * colgroup groups a set of col elements. It allows you to group several semantically
 * related columns together.
 *
 * @author Source generated with: <u>xml Bind for Java</u> by <b>Seva Safris &lt;seva@safris.org&gt;</b>
 */

public class Colgroup extends org.safris.xml.bind.runtime.lang.Binding<org.safris.xml.bind.runtime.lang.ComplexType>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "colgroup");

	static
	{
		getElementBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.Colgroup.class.getName());
	}

	private org.safris.web.depiction.schema.xhtml.strict.Colgroup.SpanAttr _spanAttr = null;
	private org.safris.web.depiction.schema.xhtml.strict.Colgroup.WidthAttr _widthAttr = null;
	...
	public Colgroup(org.safris.web.depiction.schema.xhtml.strict.Colgroup binding)
	{
		super(binding);
		if(binding instanceof org.safris.web.depiction.schema.xhtml.strict.Colgroup)
		{
			org.safris.web.depiction.schema.xhtml.strict.Colgroup element = (org.safris.web.depiction.schema.xhtml.strict.Colgroup)binding;
	...
	public void setSpanAttr(org.safris.web.depiction.schema.xhtml.strict.Colgroup.SpanAttr _spanAttr)
	{
		this._spanAttr = _spanAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Colgroup.SpanAttr getSpanAttr()
	{
		return _spanAttr;
	}

	public void setWidthAttr(org.safris.web.depiction.schema.xhtml.strict.Colgroup.WidthAttr _widthAttr)
	{
		this._widthAttr = _widthAttr;
	}

	public org.safris.web.depiction.schema.xhtml.strict.Colgroup.WidthAttr getWidthAttr()
	{
		return _widthAttr;
	}
	...
	protected void parse(org.w3c.dom.Element element) throws org.safris.xml.bind.runtime.lang.UnmarshalException, org.safris.xml.bind.runtime.lang.ValidationException
	{
		...
		for(int i = 0; i < namedNodeMap.getLength(); i++)
		{
			...
			{
				this._spanAttr = (org.safris.web.depiction.schema.xhtml.strict.Colgroup.SpanAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Colgroup.SpanAttr.class, element, attribute);
			}
			else if("width".equals(attribute.getLocalName()))
			{
				this._widthAttr = (org.safris.web.depiction.schema.xhtml.strict.Colgroup.WidthAttr)org.safris.xml.bind.runtime.lang.Binding._parseAttr(org.safris.web.depiction.schema.xhtml.strict.Colgroup.WidthAttr.class, element, attribute);
			}
	...
	public org.safris.web.depiction.schema.xhtml.strict.Colgroup clone()
	{
		return new org.safris.web.depiction.schema.xhtml.strict.Colgroup(this);
	}
	...
	public boolean equals(java.lang.Object obj)
	{
		...
		if(!(obj instanceof org.safris.web.depiction.schema.xhtml.strict.Colgroup))
			return false;

		org.safris.web.depiction.schema.xhtml.strict.Colgroup binding = (org.safris.web.depiction.schema.xhtml.strict.Colgroup)obj;
	...
	*/
	...
	public static class SpanAttr extends org.safris.web.depiction.schema.xhtml.strict.INumber<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Colgroup.SpanAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Colgroup.SpanAttr(this);
		}
	...
	*/
	...
	public static class WidthAttr extends org.safris.web.depiction.schema.xhtml.strict.IMultiLength<org.safris.xml.bind.runtime.lang.Attribute>
	{
		...
		public org.safris.web.depiction.schema.xhtml.strict.Colgroup.WidthAttr clone()
		{
			return new org.safris.web.depiction.schema.xhtml.strict.Colgroup.WidthAttr(this);
		}
