...
public abstract class IInline<T extends org.safris.xml.bind.runtime.lang.ComplexType> extends org.safris.xml.bind.runtime.lang.Binding<T>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "Inline");

	protected static IInline newInstance(final javax.xml.namespace.QName name)
	{
		return new IInline()
		{
	...
	static
	{
		getTypeBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.IInline.class.getName());
	}
	...
	public IInline(org.safris.web.depiction.schema.xhtml.strict.IInline binding)
	{
		super(binding);
	...
	public IInline(java.lang.String text)
	{
		this.text = text;
	}
	...
	public org.safris.web.depiction.schema.xhtml.strict.IInline clone()
	{
		return org.safris.web.depiction.schema.xhtml.strict.IInline.newInstance(this._getName());
	}
	...
	public boolean equals(java.lang.Object obj)
	{
		...
		if(!(obj instanceof org.safris.web.depiction.schema.xhtml.strict.IInline))
			return false;

		org.safris.web.depiction.schema.xhtml.strict.IInline binding = (org.safris.web.depiction.schema.xhtml.strict.IInline)obj;
