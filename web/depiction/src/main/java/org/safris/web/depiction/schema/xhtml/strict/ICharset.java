...
public abstract class ICharset<T extends org.safris.xml.bind.runtime.lang.BindingType> extends org.safris.xml.bind.runtime.types.StringType<T>
{
	private static final javax.xml.namespace.QName NAME = new javax.xml.namespace.QName("http://www.w3.org/1999/xhtml", "Charset");

	protected static ICharset newInstance(final javax.xml.namespace.QName name)
	{
		return new ICharset()
		{
	...
	static
	{
		getTypeBindings().put(NAME, org.safris.web.depiction.schema.xhtml.strict.ICharset.class.getName());
	}

	protected ICharset(org.safris.xml.bind.runtime.types.StringType binding)
	{
		super(binding);
	}

	protected ICharset(java.lang.String value)
	{
		super(value);
	}
	...
	public org.safris.web.depiction.schema.xhtml.strict.ICharset clone()
	{
		return new org.safris.web.depiction.schema.xhtml.strict.ICharset(this)
		{
			protected javax.xml.namespace.QName _getName()
			{
				return _getName();
