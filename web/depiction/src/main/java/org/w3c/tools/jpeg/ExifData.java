...
// Exif.java
// $Id: ExifData.java,v 1.1 2003/12/28 23:44:51 nwalsh Exp $
 ...
 * for converting the internal representation of types to equivalent Java types.
 * </p>
 *
 ...
 *
 * <p><b>Bugs:</b></p>
 * <p>The EXIF format includes unsigned integers which aren't directly available in
 * Java. Unless I'm mistaken, they'd have to be turned into longs. But that would
 * be inconvenient in other APIs. For the moment, I'm just treating them all as
 * signed. I've never seen an EXIF unsigned value too large to represent in a Java
 * int.</p>
 *
